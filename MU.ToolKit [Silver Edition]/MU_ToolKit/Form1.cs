...
namespace MU_ToolKit
{
	...
	public partial class Form1 : Form
	{
        ...
        public Form1()
        {
            ...
            // --- lê Config.ini ---
            var cfg = new IniFile("Config.ini");
            this.isEx700ItemList = cfg.ReadValue("isEx700ItemList", "0") == "1";
            this.itemListUseIgcXml = cfg.ReadValue("itemListUseIgcXml", "0") == "1";
            this.igcItemListPath = cfg.ReadValue("igcItemListPath", this.igcItemListPath);

            // Ajusta formato interno (serve para exibir no menu, etc.)
            this.ItemListFormat = itemListUseIgcXml ? "IGC" : "CLASSIC";
        }
